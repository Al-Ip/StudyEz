...
public class CardCreatorAdapter extends RecyclerView.Adapter<CardCreatorAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.frontText.setText(card.getQuestion());
        holder.backText.setText(card.getAnswer());
    ...
    public void showCardDialog(View v, final Card card) {
        ...
        frontEditText.setText(card.getQuestion());
        backEditText.setText(card.getAnswer());
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!frontInput.isEmpty() && !backInput.isEmpty()) {
                    card.setQuestion(frontInput);
                    card.setAnswer(backInput);
